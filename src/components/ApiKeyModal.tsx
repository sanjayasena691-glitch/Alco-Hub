  ...
  return (
    ...
    >
      <div
        ...
        className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl max-w-lg w-full p-6 sm:p-7 space-y-6 relative overflow-hidden animate-in fade-in zoom-in-95 duration-150"
      >
        {/* Close button */}
        <button
        ...
        <div className="flex items-start gap-3.5 pr-8">
          ...
          <div>
            <h3 id="api-key-modal-title" className="text-lg font-bold text-white leading-tight">
        ...
        <div className="p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-start gap-2.5 text-xs text-emerald-300">
          ...
          <div className="space-y-0.5">
            <p className="font-semibold text-emerald-200">Privasi Terjaga & Tersimpan Lokal</p>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                autoComplete="off"
                spellCheck="false"
                className="w-full px-3.5 py-2.5 pr-10 text-xs rounded-lg bg-slate-950 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all placeholder:text-slate-600 font-mono text-slate-100"
              />
              <button
                type="button"
            ...
            {currentKey && !savedSuccess && (
              <p className="text-[11px] text-slate-500">
                Status saat ini: <span className="font-mono text-slate-300 font-medium">{getMaskedApiKey(currentKey)}</span>
              </p>
            )}
          </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-slate-800">
            {currentKey ? (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 rounded-lg transition-colors"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                type="submit"
                className={`inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold rounded-lg shadow-xs transition-all ${
                  savedSuccess
