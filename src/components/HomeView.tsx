  ...
  return (
    <div id="alco-home-view" className="space-y-10">
      ...
      <section
        ...
        className="rounded-2xl bg-gradient-to-r from-slate-100 via-indigo-50/50 to-slate-100 dark:from-slate-900 dark:via-slate-900/90 dark:to-indigo-950/40 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 relative overflow-hidden shadow-xs"
      >
        <div className="relative z-10 max-w-3xl space-y-2">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full text-xs font-bold bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/20 mb-1">
          ...
          <p
            ...
            className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed pt-1"
          >
      ...
      {recentApp && (
        <section id="section-continue-working" className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-xs font-extrabold text-slate-500 dark:text-slate-400 tracking-wider uppercase">
              Continue Working
            </h2>
          ...
          <div
            ...
            className="p-5 sm:p-6 rounded-xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm dark:shadow-lg dark:shadow-black/20"
          >
            <div className="flex items-center gap-4 min-w-0">
              <div className="w-12 h-12 rounded-xl bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-200 dark:border-cyan-500/30 text-cyan-600 dark:text-cyan-400 flex items-center justify-center shrink-0 shadow-inner overflow-hidden">
                <AppIcon
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-cyan-50 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-500/20 shrink-0">
                    Active Module
                  </span>
                </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-cyan-600 dark:bg-cyan-500 hover:bg-cyan-500 dark:hover:bg-cyan-400 text-white dark:text-slate-950 font-bold text-xs tracking-tight transition-all shadow-sm active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 dark:focus:ring-offset-slate-950"
              >
                <span>Continue</span>
      ...
      <section id="section-core-system" className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 id="heading-core-system" className="text-lg font-bold text-slate-900 dark:text-white tracking-tight">
              Core System
            </h2>
      ...
      <section id="section-your-packs" className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 id="heading-your-packs" className="text-lg font-bold text-slate-900 dark:text-white tracking-tight">
              Your Packs
            </h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">
