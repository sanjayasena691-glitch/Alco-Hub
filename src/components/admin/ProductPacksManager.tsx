      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-2xl bg-slate-900 border border-slate-800">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-md text-[10px] font-extrabold uppercase tracking-wider bg-purple-500/10 text-purple-300 border border-purple-500/20 flex items-center gap-1">
      ...
      {isEditing ? (
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-800 pb-4">
            <div>
              ...
              <p className="text-xs text-slate-400">
                Data pack akan tersimpan di tabel <code className="text-purple-300 font-mono">product_packs</code> di Supabase.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Nama Product Pack</label>
              <input
                type="text"
                value={formName}
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">
                Pack ID / Slug{' '}
                {editingPackId && (
                  <span className="text-[10px] text-amber-400 font-normal">(Terkunci untuk integritas)</span>
                )}
              </label>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Kategori / Kelompok</label>
              <input
                type="text"
                value={formCategory}
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Aksen Warna Tema</label>
              <select
                value={formAccent}
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Badge Label (Opsional)</label>
              <input
                type="text"
                value={formBadge}
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Status Pack</label>
              <select
                value={formStatus}
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-slate-300">Deskripsi Lengkap Pack</label>
            <textarea
              value={formDesc}
          ...
          <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-800">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-lg bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold shadow-md disabled:opacity-50"
            >
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-[11px] text-slate-500 font-mono">
                    ...
                    <span>•</span>
                    <span className="text-indigo-400 font-semibold">{count} Aplikasi Terhubung</span>
                  </div>

                  {pack.tagline && (
                    <p className="text-xs text-slate-300 font-medium">{pack.tagline}</p>
                  )}
                ...
                <div className="pt-3 border-t border-slate-800 flex items-center justify-between text-xs">
                  <span className="text-[11px] text-slate-500">{pack.category || 'Ecosystem Pack'}</span>
