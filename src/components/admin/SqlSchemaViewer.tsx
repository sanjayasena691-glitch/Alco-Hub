          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">
                Mendukung tabel <code className="text-purple-300">product_packs</code> (dengan <code className="text-purple-300">tool_count</code>), relasi <code className="text-indigo-300">pack_id</code>, <code className="text-cyan-300">trial_duration_days</code>, <code className="text-emerald-300">access_model</code>, dan Owner RLS security policies.
              </p>
            </div>
          </div>
          <button
