...
export const ECOSYSTEM_APPS: EcosystemApp[] = [
  ...
  // ==========================================
  {
    ...
    version: '1.0.2',
    latestVersion: '1.0.2',
    releaseNotes: 'Official production release v1.0.2: Strategy, research & creative angle formulation.',
    downloadUrl: 'https://github.com/yaladzan92-creator/Alco-Releases/releases/download/alco-creative-sytem-v1.0.2/ALCO.Creative.System.Setup.1.0.2.exe',
  ...
  },
  {
    ...
    version: '1.0.1',
    latestVersion: '1.0.1',
    releaseNotes: 'Update v1.0.1: Peningkatan stabilitas video motion renderer, kinetic typography preset updates, dan integrasi deteksi versi resmi ALCO Hub.',
    downloadUrl: 'https://github.com/Alco-Releases/alco-auto-motion/releases/download/alco-auto-motion-v1.0.1/ALCO%20Auto%20Motion%20Setup%201.0.1.exe',
